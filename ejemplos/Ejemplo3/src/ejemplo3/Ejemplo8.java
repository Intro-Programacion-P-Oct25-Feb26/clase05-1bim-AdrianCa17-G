...
public class Ejemplo8 {
    ...
    public static void main(String[] args) {
        ...
        // >= 0 and < 3 Reprobado
        // cualquier otra nota, ssera nota fuera de rango
        // las notas no pueden pasar de 10
        // Si la nota fuera de rango es negativa hay que indicarla 
        double promedio = 8;
        String mensaje = "";
        ...
        if ((promedio >= 7.5) && (promedio <= 10)) {
            ...
            //        + "promedio: %.2f\n", promedio);
            //mensaje = "Estudiante en suspenso con un 
            // promedio: " + promedio;
            ...
            if ((promedio >= 5) && (promedio < 7.5)) {
                ...
                if ((promedio >= 3) && (promedio < 5)) {
                    ...
                    mensaje = String.format("Estudiante reprobado con un "
                        ...
                        if(promedio < 0){
                        // System.out.printf("La nota: %.2f esta fuera
                        // de rango y es negativa \n",promedio);
                        mensaje = String.format("La nota: %.2f esta fuera de rango y "
                                + "es negativa \n",promedio);
                        }else{
                            // System.out.printf("La nota: %.2f esta fuera "
                            //    + "de rango y es positiva \n",promedio);
                            mensaje = String.format("La nota: %.2f esta fuera de rango y "
                                + "es negativa \n",promedio);
                        }
                    }
